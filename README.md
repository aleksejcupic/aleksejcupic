...
**Open to** backend & full-stack software engineering roles (C#/.NET · SQL · Angular) — including fintech, trading systems, and quant development.
...
Garman-Kohlhagen, binomial, Monte Carlo/LSM, exotics), bonds & yield curves, derivatives,
...
A single self-contained ExcelDNA add-in exposing the library above as ~150 native Excel
functions, with input validation, an async pricing path, a settings ribbon, and ~98% test
coverage. Built and released via GitHub Actions.
